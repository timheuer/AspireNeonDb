...
/// </summary>
public class NeonServerResource : ContainerResource, IResourceWithConnectionString
{
    ...
    public NeonServerResource(string name, ParameterResource? userName, ParameterResource password) : base(ThrowIfNull(name))
    {
